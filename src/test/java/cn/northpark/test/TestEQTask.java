...
//				
//				
//				List<Vps> findAll = vpsManager.findAll();
//				
//				for (int i = 0; i < findAll.size(); i++) {
//					findAll.get(i).setTitle(findAll.get(i).getTitle().replace("-VPS推荐网", ""));
//					vpsManager.updateVps(findAll.get(i));
//				}
//				
//				
//
