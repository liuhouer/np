        ...
        <div class="mainbody" style="margin-top:80px; ">
            ...
            <div class="row">
                <div class="col-sm-8 col-md-offset-2">
                    <form class=" form-search " action="/movies/search" id="J_ser_from" method="post"
                        ...
                        <div class="clearfix bg-white margin-t10 margin-b10 padding20">
                            <div class="row">
                                ...
                                <div class="col-sm-8  col-md-offset-2 ">
                                    ...
                                    <a title="${s.moviename}的简介" href="/movies/post-${s.id }.html">${s.moviename}</a>
                                    简介：</p>
