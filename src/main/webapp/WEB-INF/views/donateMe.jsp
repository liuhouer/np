					...
					<div class="container mainbody">
						<div class="col-sm-7" style="color:#888">
							<div class="content margin-b20">
								...
								<p>
									为了给大家提供更好更优秀的服务，即日起，NorthPark中文网在原有基础上推出赞助VIP荣誉会员，同时针对VIP荣誉会员，增加特以下荣誉会员增值服务（直接打赏，NorthPark中文网也很欢迎哦~）
								</p>
								<ul>
									<li>
										优先响应软件，游戏，影视资源求档请求；
									...
									<li>
										提供专享 Teamviewer 远程协助请求；
									</li>
									<li>
										提供专享QQ，微信一对一在线即时帮助、咨询、安装、调试；
									</li>
									<li>
								...
								<p>
									...
									网站上，使用【转账到支付宝】手动转账相应金额到 15010670155 ：
								</p>
								<p style="text-align: center;">
									收款人：15010670155
								</p>
								...
								<p>
									3、在手机上使用【微信】，使用【扫一扫】功能，扫描下面的二维码图片后向本站赞助相应金额；
								</p>
								<p style="text-align: center;">
