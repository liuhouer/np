...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet" href="/statics/css/login/owl-login.css">
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand">
                <a href="http://blog.NorthPark.cn/atom.xml" target="_blank" id="icon" title="订阅NorthParkRSS"><img
                        src="/statics/img/rss.png" width="20" height="20" alt="订阅NorthPark博客RSS"></a>
            </div>
        </div>
...
<script src="/statics/js/page/reg2.js"></script>
