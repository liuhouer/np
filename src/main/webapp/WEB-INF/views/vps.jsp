...
<head>
    ...
    <meta name="keywords"
          content="NorthPark,国外主机,国外VPS,国外服务器,VPS服务器,VPS主机,便宜VPS,美国VPS,美国主机,美国服务器,主机空间,主机推荐,VPS推荐,服务器推荐,虚拟主机,便宜服务器">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-sm-12">
                        ...
                        <form class="form-search " id="J_ser_from" method="post" accept-charset="UTF-8"
                              action="/vps/mac/page/1">
                            <input id="keyword" placeholder="你享要的优惠啦~" value="${keyword }"
                        ...
                        <c:forEach var="z" items="${tagCloud }">
                            ...
                            <div class="col-md-10 margin5 avatar">
                                <c:if test="${z.tagscloud == seltag }">
                                    ...
                                    <a style="color: #45d0c6;" href="/vps/tag/${z.tagscloud }"
                                       title="${z.tagscloud }">${z.tagscloud } </a>
                                </c:if>
                                <c:if test="${z.tagscloud != seltag }">
