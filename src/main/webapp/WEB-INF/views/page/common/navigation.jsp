	...
	<div class="container">
		<div class="navbar-header">
			...
			<div class="navbar-brand">
													<a <c:if test="${user!=null }">href="/cm/pcentral"</c:if><c:if test="${user==null }">href="/login"</c:if>  class="mainhead-avatar"><img src="/img/davatar.jpg" class="img-circle max-width-50" height="40" width="40"></a>
