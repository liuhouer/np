    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse mainhead-collapse">
            <ul class="nav mainhead-nav" id="J_tabs">
                ...
                <li cname="movies"><a href="/movies" title="包含最新的影视剧资源"><i class="fa fa-film padding5"></i>影视窝</a></li>
                <li cname="soft"><a href="/soft/mac" title="丰富的Mac软件资源"><i class="fa fa-apple padding5"></i>Mac软件</a>
                </li>
                <li cname="pic"><a href="/love" title="最爱主题图册"><i class="fa fa-picture-o padding5"></i>最爱</a></li>
                <li cname="note"><a href="/note/list" title="碎碎念的精神角落"><i class="fa fa-comment padding5"></i>留言</a></li>
                <li cname="pcenter">
