                    ...
                    <div class="clearfix margin-t20">
                            ...
                            <div class="row">
                                <div class="col-xs-3 col-sm-2">
                                    <a
                                            ...
                                            <c:if test="${user.headpath == null}">src="/statics/img/davatar.jpg"</c:if>
                        ...
                        <div class="row center">
                            <div class="row margin-b20" id="loadingAnimation">
                                <img alt="load comment of ${ datamap.lrc_title}" src="/statics/img/loading.gif" width="30"
                                     height="30">
                            </div>
...
<script src="/statics/js/page/zancmt.js"></script>
