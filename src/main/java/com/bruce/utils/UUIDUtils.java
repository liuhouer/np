...
public class UUIDUtils  implements java.io.Serializable, Comparable<UUIDUtils> {
	     ...
	     */
	    public static UUIDUtils getUUID() {
		...
		if (!(obj instanceof UUIDUtils))
		    return false;
	        if (((UUIDUtils)obj).variant() != this.variant())
	            return false;
