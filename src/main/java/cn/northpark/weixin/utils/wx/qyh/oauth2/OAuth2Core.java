package cn.northpark.weixin.utils.wx.qyh.oauth2;
...
public class OAuth2Core {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getCode("http://wx.ngrok.xiaomiqiu.cn/weixin/wxastro?type=today"));
        System.out.println(getCode("http://wx.ngrok.xiaomiqiu.cn/weixin/wxastro?type=tomorrow"));
        System.out.println(getCode("http://wx.ngrok.xiaomiqiu.cn/weixin/wxastro?type=week"));
        System.out.println(getCode("http://wx.ngrok.xiaomiqiu.cn/weixin/wxastro?type=month"));
