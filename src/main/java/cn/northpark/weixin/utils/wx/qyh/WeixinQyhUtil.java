package cn.northpark.weixin.utils.wx.qyh;
...
import cn.northpark.weixin.utils.wx.qyh.ParamesAPI.AccessToken;
import cn.northpark.weixin.utils.wx.qyh.ParamesAPI.ParamesAPI;
import cn.northpark.weixin.utils.wx.qyh.menu.Menu;
...
public class WeixinQyhUtil {
    ...
    // 菜单创建（POST）
    public static String menu_create_url = "https://qyapi.weixin.qq.com/cgi-bin/menu/create?access_token=ACCESS_TOKEN&agentid=5";
    ...
    public static int createMenu(Menu menu, String accessToken) {
        ...
        if (null != jsonObject) {
            if (0 != jsonObject.getInteger("errcode")) {
                ...
                String error = "创建菜单失败 errcode:{" + result + "} errmsg:{" + jsonObject.getString("errmsg") + "}";
                System.out.println(error);
            }
        }
    ...
    public static int PostMessage(String access_token, String RequestMt, String RequestURL, String outstr) {
        ...
        JSONObject jsonobject = WeixinQyhUtil.httpRequest(RequestURL, RequestMt, outstr);
        if (null != jsonobject) {
            if (0 != jsonobject.getInteger("errcode")) {
                result = jsonobject.getInteger("errcode");
