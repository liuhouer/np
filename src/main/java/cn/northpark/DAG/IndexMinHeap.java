...
//        for (int i = 1; i < N; i++) {
//            indexMinHeap.insert(i, N - i);
//        }
//        int index = indexMinHeap.extractMinIndex();


        IndexMinHeap<Integer> indexMinHeap = new IndexMinHeap<Integer>(7);

        indexMinHeap.insert(1,9999);
        indexMinHeap.insert(0,9999);
        indexMinHeap.insert(2,2);
        indexMinHeap.insert(3,1);
        indexMinHeap.insert(4,6);
        indexMinHeap.insert(5,1);
        indexMinHeap.insert(6,1);

        int index = indexMinHeap.getMinIndex();
        int index2 = indexMinHeap.getMinIndex();
        int index3 = indexMinHeap.getMinIndex();
