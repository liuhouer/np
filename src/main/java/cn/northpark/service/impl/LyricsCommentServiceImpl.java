...
//        return lyricscommentMapper.selectByPrimaryKey(id);
//    }
//
//    @Override
//    public List<LyricsComment> findAll() {
//        return lyricscommentMapper.selectAll();
//    }
//
//    @Override
//    public void addLyricsComment(LyricsComment lyricscomment) {
//        lyricscommentMapper.insert(lyricscomment);
//    }
//
//    @Override
//    public boolean delLyricsComment(Integer id) {
//        LyricsComment lyricscomment = lyricscommentMapper.selectByPrimaryKey(id);
//        lyricscommentMapper.deleteByPrimaryKey(lyricscomment);
//        return true;
//    }
//
//    @Override
//    public boolean updateLyricsComment(LyricsComment lyricscomment) {
//        lyricscommentMapper.updateByPrimaryKey(lyricscomment);
//        return true;
//    }
//
...
//        QueryResult qrs = lyricscommentMapper.findByCondition(p.getFirstResult(),
...
//        QueryResult qrs = lyricscommentMapper.findByCondition(
//                wheresql);
//        return qrs;
//    }
//
...
//        // TODO Auto-generated method stub
//        return lyricscommentMapper.querySql(sql, LyricsComment.class, obj);
//    }
//
//    @Override
//    public List<LyricsComment> querySql(String sql) {
//        // TODO Auto-generated method stub
//        return lyricscommentMapper.querySql(sql, LyricsComment.class);
//    }
//
//    @Override
//    public List<Map<String, Object>> querySqlMap(String sql, PageView<List<Map<String, Object>>> pageView) {
//        // TODO Auto-generated method stub
//        return lyricscommentMapper.querySQLForMapList(sql, pageView);
//    }
//
//    /* (non-Javadoc)
...
//        // TODO Auto-generated method stub
//        return lyricscommentMapper.countSql(sql);
//    }
//
//    /* (non-Javadoc)
...
//        // TODO Auto-generated method stub
//        return lyricscommentMapper.countHql(LyricsComment.class, wheresql);
//    }
//
//    @Override
...
//            PageView<List<Map<String, Object>>> pageView, String sql) {
//        // TODO Auto-generated method stub
//        return lyricscommentMapper.querySQLCountForMapList(sql, pageView);
//    }
//}
//
