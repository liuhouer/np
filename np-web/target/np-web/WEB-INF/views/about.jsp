            ...
            <div class="row">
                ...
                <div class="col-sm-offset-1 col-sm-4" style="color:#888">
                    <div class="row bg-lblue padding20 radius-5">
                        ...
                        <hr>
                        <p>联系邮箱：<a href="mailto:zhangyang.z@iCloud.com">zhangyang.z@iCloud.com</a></p>
                        <p>联系QQ ：654714226</p>
                    </div>
                    <div class="row bg-lblue padding20 radius-5">
                    ...
                    <div class="row bg-lblue padding20 radius-5">
                        ...
                        <hr>
                        <p>声明：本站所有影视资源，软件资源，学习资源，文章资源均来自互联网，本站不承担任何法律责任及连带责任。
                        </p>
                        <p>如有侵权，发邮件会及时删除。
                        </p>
                        <p>树洞、最爱属于UGC，请不要上传、编写、讨论不良内容
                        </p>
                        <p>联系邮箱：<a href="mailto:qhdsoftware@163.com">qhdsoftware@163.com</a></p>
                    </div>
                </div>
